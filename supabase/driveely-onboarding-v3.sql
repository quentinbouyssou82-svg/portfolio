-- ═══════════════════════════════════════════════════════════════════════════
-- Driveely — migration Auth + Onboarding (v3)
-- ═══════════════════════════════════════════════════════════════════════════
--
-- Remplace : driveely-onboarding-v3.sql (et toute migration onboarding antérieure)
--
-- Où l'exécuter :
...
--   (DRIVEELY-MIGRATION-FINAL.sql ou équivalent déjà appliqué)
--
-- Sécurité :
