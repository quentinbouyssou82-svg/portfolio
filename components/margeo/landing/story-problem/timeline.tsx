...
export const TIMELINE_STEPS: {
...
}[] = [
  {
    icon: Bell,
    title: "Notification",
    detail: "7 € en vert. 15 secondes pour décider.",
    tone: "neutral",
  },
  {
    icon: Smartphone,
    title: "Tu acceptes",
    detail: "Un tap. Pas le temps de calculer.",
    tone: "neutral",
  },
  {
    icon: Car,
    title: "Tu roules",
    detail: "Km, feux, stress — le compteur tourne.",
    tone: "neutral",
  },
  {
    icon: Navigation,
    title: "Embouteillages",
    detail: "Le temps explose. Ton €/h s'effondre.",
    tone: "warn",
  },
  {
    icon: Coffee,
    title: "Attente restaurant",
    detail: "10 min debout. Non payées.",
    tone: "warn",
  },
  {
    icon: MapPin,
    title: "Retour à vide",
    detail: "Zone morte. Personne ne te le paie.",
    tone: "danger",
  },
  {
    icon: Fuel,
    title: "Essence",
    detail: "−1,20 € sur cette course.",
    tone: "danger",
  },
  {
    icon: Wrench,
    title: "Usure",
    detail: "Pneus, freins — invisible à l'écran.",
    tone: "danger",
  },
  {
    icon: TrendingDown,
    title: "Presque pour rien",
    detail: "Tu as travaillé. Tu n'as presque rien gagné.",
    tone: "danger",
  },
];
