/**
 * Vérifie les variables d'environnement Driveely beta.
 * Usage : node scripts/driveely-beta-check.mjs
 */
...
const optional = [
  "DRIVEELY_BETA_MODE",
  "DRIVEELY_VISION_PROVIDER",
  "DRIVEELY_MISTRAL_VISION_MODEL",
  "NEXT_PUBLIC_POSTHOG_KEY",
];

console.log("Driveely — vérification environnement beta\n");
...
const visionProvider =
  process.env.DRIVEELY_VISION_PROVIDER?.trim().toLowerCase() || "mistral";
...
console.log(
  ...
  hasVisionKey
    ...
    : "(MISTRAL_API_KEY ou DRIVEELY_GEMINI_API_KEY manquant)",
);
