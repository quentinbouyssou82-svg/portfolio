/**
 * Exécute les migrations Driveely sur Supabase via connexion Postgres.
 * Nécessite SUPABASE_DB_PASSWORD (Dashboard → Settings → Database).
 * Usage : SUPABASE_DB_PASSWORD=... node scripts/run-driveely-migrations.mjs
 */
