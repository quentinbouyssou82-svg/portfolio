 ...
 *
 * Usage: npx tsx scripts/apply-uberly-subscriptions.ts
 */
...
async function main() {
  ...
  console.log("  supabase/uberly-subscriptions-v1.sql");
  console.log("");
  const sqlPath = resolve("supabase/uberly-subscriptions-v1.sql");
