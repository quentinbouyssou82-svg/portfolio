...
const FAQ_ITEMS = [
  {
    question: "Comment Margeo lit-il mes captures d'écran ?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Margeo applique ton coût au kilomètre (carburant, usure, assurance) sur la distance totale — retour à vide inclus — et ajoute un coût du temps immobilisé. Le résultat, c'est ce qui reste vraiment dans ta poche.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Jamais. Tes captures et tes statistiques restent privées. Margeo travaille pour toi, pas pour les plateformes.",
  },
  {
    question: "Margeo est-il vraiment gratuit ?",
    answer:
  ...
  return (
    <section id="faq" className="scroll-mt-20 border-t border-border py-24">
      <div className="mx-auto max-w-3xl px-5">
        ...
        <Reveal
          delay={0.1}
          className="mt-12 rounded-2xl border border-border bg-card px-6 shadow-card"
        >
