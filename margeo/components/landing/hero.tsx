      ...
      <div className="relative mx-auto max-w-6xl px-5">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <motion.p
            ...
            className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-muted text-pretty"
          >
            Capture la proposition, dépose-la dans Margeo. L&apos;IA extrait les
          ...
          >
            Gratuit · Sans carte bancaire · Compatible Uber Eats, Deliveroo,
            Shopopop, Stuart, Amazon Flex
          </motion.p>
        </div>
